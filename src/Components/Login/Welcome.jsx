    ...
    return(
        <div id="form" className="flex flex-col md:w-[500px] md:h-[550px] gap-y-[30px]  bg-white items-center p-[25px]">
            ...
            <p className="text-sm text-[#6358DC] font-normal"><a>Forgot password?</a></p>
                ...
                <button className="md:w-[400px] md:h-[45px] text-white  bg-[#6358DC] rounded-[5px] hover:bg-white hover:text-[#6358DC] hover:border-2 hover:border-[#6358DC] font-normal md:text-[17px]"type="submit" >Connexion</button>
               </form>   
