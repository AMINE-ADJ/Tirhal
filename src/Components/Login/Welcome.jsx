    ...
    return(
        <form className="flex flex-col md:w-[500px] md:h-[550px] gap-y-[30px]  bg-white items-center p-[25px]">
            ...
            {inputs.map((index)=>(
              ...
              <input className="md:w-[350px] md:h-[35px] outline-none bg-[#ECECEC] " placeholder={index.description} type={index.type}></input>
          </div>
            ))}
            ...
            <p className="text-sm text-[#6358DC]"><a>Forgot password?</a></p>
                ...
                <p className="md:text-black font-medium">Continuer avec Google</p>
                </div></a>
